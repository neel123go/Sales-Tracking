        ...
        <div className='px-20'>
            <footer class="footer footer-center p-10 bg-base-100  rounded">
                ...
                <div className="mt-[-20px]">
                    <p>Copyright © 2022 - All right reserved by Sales Tracking Ltd.</p>
                </div>
            </footer>
